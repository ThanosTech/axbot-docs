...
在您准备开始了解和使用 AXBot 之前，我们可能要提醒您，聊天机器人的所有功能都是通过对话触发的，用起来是十分繁琐的。

如果您不想记住复杂的命令，又或者是想点点界面就能使用功能，那么，AXBot 开发团队最新推出的 微信QQ双端小程序 “战雷小助手”，它可以为您提供类似 AXBot 的功能，并且拥有更加便捷的使用体验。
...
!!! info "小程序的功能"
    由于小程序是 AXBot 后续开发的产物，所以个别 AXBot 支持的功能暂时无法在小程序中使用。不过小程序会持续更新，未来会支持更多功能。

    当然，小程序有更多的功能是 AXBot 不支持的，这就等待你的探索啦。
...
目前 AXBot 由一个小型团队进行开发。根据团队中每个人的个人意愿，我们会不定期的进行团队人员配置上的调整。

> 请放心，我们都是严选雷批，做的功能还是会切合大家的想法和需求，不会像 BVVD 大人一样不玩自己做的游戏
