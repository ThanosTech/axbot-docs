...
尽管Gaijin对此并不表示反对，但也不代表着Gaijin官方对AXBot机器人持有支持的态度。所以在未来可能的“回旋镖”扎到我之前，AXBot机器人依然会遵循Gaijin的要求，会且只会使用玩家公开数据来提供服务。

### 3. 能不能分离整体数据为具体模式（空历，陆历）的数据？
